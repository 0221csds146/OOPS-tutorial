...
# >>Single child class derived attributes from single parent class
...
# >child class inherits from his Father class and Father class inherits from Grandfather class
...
#>>Child class inherits property from multiple child class
# Common base class
# class A:
#     def __init__(self, name):
#         self.name = name
